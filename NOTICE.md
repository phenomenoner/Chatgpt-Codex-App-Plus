...
The vendored collection and pointer catalog refer to OpenAI Codex, ChatGPT, Claude, MCP, A2A, and other products or standards. Those names and trademarks belong to their respective owners. This independent community project is not endorsed by or affiliated with OpenAI, Anthropic, the Model Context Protocol project, or referenced upstream projects.
